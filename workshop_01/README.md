...
Pre replikovanie dema je potrebné vojsť do priečinku [workshop_01/containers/demo-vue-app](workshop_01/containers/demo-vue-app). Informácie potrebné pre lokálne spustenie vývojovej verzie aplikácie, 
ako aj pre vytvorenie oboch kontajnerových image-ov nájdete v príslušnom [README.md](workshop_01/containers/demo-vue-app/README.md) súbore.
...
V poslednej časti workshopu sme si overili úspešnú inštaláciu `minikube` a `kubectl`, následne sme prešli na prvé cvičenia podľa [týchto inštrukcií](workshop_01/lab/lab.md).
